    ...
    return (
      <header id="header">
        <div id="header-grid">
          <nav>
            <ul id="menulink">
              <Link id="navbutton-name" to="/">
                cw
              </Link>
              {/* <Link className="navbutton" to="/about">about</Link> */}
              <Link className="navbutton" to="/goals">
                goals
              </Link>
              ...
              <Link className="navbutton" to="/work">
                work
              </Link>
            </ul>
          </nav>
          <button
            ...
            role="link"
            onClick={() =>
              openInNewTab("https://www.linkedin.com/in/cjcwallace/")
            }
          >
          ...
          <button
            ...
            role="link"
            onClick={() => openInNewTab("https://github.com/cjcwallace")}
          >
            <svg width="35" height="35" viewBox="0 0 30 30">
